...
> **Project status:** all shipped in `main` (2026-08-16) — user-defined themes and metrics,
> statement-driven data, the **V2 UI** (Overview, Model, Rebalance, Research, History), **accounts**
> (you sign in; your portfolio lives in your account and nowhere else), a first-run guide, no
> built-in default themes — you build your own — and a rolling history of your **10 most recent
> checkpoints**. The native **iOS app** runs on a physical iPhone but is **parked at V1**; it will be
> rebuilt against the new web baseline ([`docs/V2_WEB_BASELINE.md`](docs/V2_WEB_BASELINE.md)).
